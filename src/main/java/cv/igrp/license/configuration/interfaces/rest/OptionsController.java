...
import cv.igrp.license.configuration.application.commands.CreateOptionsCommand;
import cv.igrp.license.configuration.application.commands.DisableOptionCommand;
import cv.igrp.license.configuration.application.commands.EnableOptionCommand;
import cv.igrp.license.configuration.application.commands.UpdateOptionCommand;
...
import cv.igrp.license.configuration.application.dto.WrapperListOptionsDTO;
import cv.igrp.license.configuration.application.queries.ExistsByCcodeQuery;
import cv.igrp.license.configuration.application.queries.FindByCcodeQuery;
import cv.igrp.license.configuration.application.queries.GetListOptionsQuery;
import cv.igrp.license.configuration.application.queries.GetOptionByIdQuery;
...
public class OptionsController {
  ...
  public ResponseEntity<OptionResponseDTO> findByCcode(
    @PathVariable(value = "ccode") String ccode)
  {

      LOGGER.debug("Operation started");

      final var query = new FindByCcodeQuery(ccode);
  ...
  @GetMapping(
    value = "{ccode}/existsByCcode"
  )
  @Operation(
    summary = "GET method to handle operations for existsByCcode",
    description = "GET method to handle operations for existsByCcode",
    responses = {
      @ApiResponse(
          responseCode = "200",
          description = "",
  ...
  public ResponseEntity<Boolean> existsByCcode(
    @PathVariable(value = "ccode") String ccode)
  {

      LOGGER.debug("Operation started");

      final var query = new ExistsByCcodeQuery(ccode);
