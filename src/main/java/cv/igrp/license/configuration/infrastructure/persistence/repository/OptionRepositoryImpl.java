...
import cv.igrp.license.shared.infrastructure.persistence.repository.OptionsEntityRepository;
...
public class OptionRepositoryImpl implements OptionRepository {
  ...
  @Override
  public boolean existsByKeyAndCode(String ckey, String ccode) {
    return false;
  }
  ...
  @Override
  public Optional<Option> findByCcode(String ccode) {
    return optionEntityRepository.findByCcode(ccode)
        .map(optionMapper::toDomain);
  }
}
